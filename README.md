...
### 🎙️ Test Lecteur Audio (Sandbox)

**Français**
<audio src="https://github.com/pierrentsama/foliotype-protocol/blob/master/assets/output/mastered/foliotype_protocol_incipit_fr.mp3?raw=true" controls preload="none"></audio>

**English**
<audio src="https://github.com/pierrentsama/foliotype-protocol/blob/master/assets/output/mastered/foliotype_protocol_incipit_en.mp3?raw=true" controls preload="none"></audio>
---

### 🎬 Video Asset
* [Télécharger la vidéo de présentation](https://github.com/pierrentsama/foliotype-protocol/raw/master/assets/output/mastered/foliotype_protocol_banniere_video.mp4)

> **Note technique** : Pour garantir une fidélité visuelle optimale et contourner les restrictions de débit du streaming GitHub, le téléchargement direct est privilégié.

---

### 🚀 Contact & Business
Pour toute demande de déploiement, collaboration ou essai du protocole :
**Email** : `contact@votre-domaine.com` (ou votre adresse ik.me)
